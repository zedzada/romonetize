...
// Store last webhook event info for debugging
let lastWebhookEvent: {
  type: string;
  timestamp: string;
  success: boolean;
  error?: string;
...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    webhookRouteExpected: "/api/webhook",
    webhookSecretConfigured,
    lastWebhookEvent: lastWebhookEvent || null,
    lastWebhookReceivedAt: lastWebhookEvent?.timestamp || null,
    lastWebhookError: lastWebhookEvent?.error || null,
